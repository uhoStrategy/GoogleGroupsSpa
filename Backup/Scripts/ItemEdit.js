var GoogleGroupsSpa = GoogleGroupsSpa || {};

GoogleGroupsSpa.itemViewModel = function (moduleId, resx) {
    var service = {
        path: "GoogleGroupsSpa",
    ...
    var loadUsers = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            var result = data[i];
            var user = new GoogleGroupsSpa.user(result.id, result.name);
...
GoogleGroupsSpa.user = function (id, name) {
    this.id = id;
    this.name = name;
}